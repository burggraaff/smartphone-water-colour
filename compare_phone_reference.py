...
plot.correlation_plot_R_rs(data_reference, data_phone, xlabel=f"{reference} {label_R_rs} {plot.persr}", ylabel=f"{cameralabel} {label_R_rs} {plot.persr}", title="Smartphone-reference\nreflectance comparison", saveto=f"{saveto_base}_R_rs.pdf", saveto_stats=f"{saveto_base}_R_rs.dat", compare_to_regression=True)
...
plot.correlation_plot_bandratios_combined(data_reference, data_phone, xlabel=f"{reference} {label_R_rs} band ratio", ylabel=f"{cameralabel} {label_R_rs} band ratio", title="Smartphone-reference\nband ratio comparison", saveto=f"{saveto_base}_band_ratio_combined.pdf", saveto_stats=f"{saveto_base}_band_ratio_combined.dat")
