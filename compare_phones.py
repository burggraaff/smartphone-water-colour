...
plot.correlation_plot_bandratios_combined(data1, data2, datalabel="R_rs", errlabel="R_rs_err", quantity=label_R_rs, xlabel=phone1_name, ylabel=phone2_name, saveto=f"{saveto_base}_band_ratio_combined.pdf")
