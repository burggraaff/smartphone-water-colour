...
plot.correlation_plot_radiance_combined(data1, data2, xlabel=f"{data_label1} $L$ [a.u.]", ylabel=f"{data_label2} $L$ [a.u.]", title="RAW-JPEG radiance comparison", regression="rgb", saveto=f"{saveto_base}_radiance_simple.pdf")

# Correlation plot: Remote sensing reflectance
label_R_rs = plot.keys_latex["R_rs"]
plot.correlation_plot_R_rs(data1, data2, xlabel=f"{data_label1} {label_R_rs} {plot.persr}", ylabel=f"{data_label2} {label_R_rs} {plot.persr}", title="RAW-JPEG reflectance comparison", saveto=f"{saveto_base}_R_rs.pdf")
...
plot.correlation_plot_bandratios_combined(data1, data2, xlabel=f"{data_label1} {label_R_rs} band ratio", ylabel=f"{data_label2} {label_R_rs} band ratio", title="RAW-JPEG band ratio comparison", saveto=f"{saveto_base}_band_ratio_combined.pdf")
